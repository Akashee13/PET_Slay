...
- Started `T052` security hardening:
  ...
  - Stage can also use `STAGE_BUYER_BEARER_TOKEN` for Expo/mobile buyer validation until proper buyer auth is wired.
...
- Added React Native catalog polish toward `T053`:
