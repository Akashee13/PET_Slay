...
- Started `T052` API role-boundary hardening:
  ...
  - `STAGE_BUYER_BEARER_TOKEN` is now supported for stage Expo/mobile buyer validation until real buyer auth is wired.
...
- Mobile auth is provider-ready but not fully OAuth-complete:
