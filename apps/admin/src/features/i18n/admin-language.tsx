...
const COPY: Record<AdminLanguage, Record<AdminCopyKey, string>> = {
  english: {
    ...
    productsNav: "Product Operations",
    ...
    addProductTitle: "Product Operations",
    addProductSubtitle: "Open add or edit product flows in focused pop-up forms with prefilled data and size selection.",
  },
  hindi: {
    operationsLanguage: "ऑपरेशन भाषा: हिन्दी",
    ordersNav: "ऑर्डर ऑपरेशन",
    productsNav: "प्रोडक्ट ऑपरेशन",
    ...
    addProductTitle: "प्रोडक्ट ऑपरेशन",
    addProductSubtitle: "ऐड और एडिट फ्लो को focused popup forms में खोलें, जहाँ prefilled data और size selection मिले।",
  },
  hinglish: {
    ...
    addProductEyebrow: "Catalog Intake",
    addProductTitle: "Product Operations",
    addProductSubtitle: "Add aur edit product flows focused popup forms me kholo, jahan prefilled data aur size selection mile.",
  },
};
